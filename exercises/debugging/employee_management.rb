...
class Employee
  ...
  protected # instead of `private`. this way, #serial_number can be called by other employees (objects in the same Employee class), which is necessary for the equality comparison

  attr_reader :serial_number

  private # LS solution includes putting `private` back in here so we don't unnecessarily expose #abbreviated_serial_number
