class Length
  ...
  # sort uses the <=> operator which we need to define here:
  # def <=>(other)
  #   if self < other
  #     -1
  #   elsif self == other
  ...
  #   end
  # end
  # my version above worked because of other definitions already doing the conversion
  ...
  # with this in place, can simply include Comparable module and remove the comparison methods
  # the Comparable module implements the other methods based on the #<=> definition
...
# => comparison of Length with Length failed (ArgumentError) # initial error before fixing
# expected output:
# 1 km
# 1 mi
# 1 nmi
